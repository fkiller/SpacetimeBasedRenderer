...
export class LaserPointer {
    ...
    geometry;
    positions;
    workingDir = new Vector3();
    workingPos = new Vector3();
    workingForce = new Vector3();
    temp = new Vector3();
    active = false;
    ...
    update(origin, direction, blackHoles) {
        if (!this.active) {
            return;
        }
    ...
    applyGravitationalBend(blackHoles, step) {
...
//# sourceMappingURL=LaserPointer.js.map